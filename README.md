...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/6089883d7dbda80018d55ce9
...
To start editing your site, you can use the Sanity interface at https://hs-9883d.sanity.studio/.
...
Generated at `2021-04-28T16:07:50.562Z` by Stackbit version `0.3.51`.